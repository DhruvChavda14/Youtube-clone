...
function VideoPage() {
  ...
  const handleTripleClick = debounce((e) => {
    ...
    if (clickX > rightBoundary) {
      ...
      if (firstMoreVideo) {
        videoRef.current.src = `https://youtube-clone1403.netlify.app/${firstMoreVideo.filePath}`;
        videoRef.current.play();
      }
    }
  }, 300);
    ...
    <div className="container_videoPage">
      <div className="container2_videoPage">
        <div className="video_display_screen_videoPage">
          <video
            ref={videoRef}
            src={`https://youtube-clone1403.netlify.app/${vv?.filePath}`}
            ...
            moreVideos?.map((video) => (
              <div key={video._id} className="moreVideoItem">
                <Link to={`/video/${video._id}`} className="moreVideoLink">
                  <video src={`https://youtube-clone1403.netlify.app/${video.filePath}`} className="moreVideoThumbnail" />
                </Link>
